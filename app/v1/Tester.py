...
def bug_type():
    ...
    if tester_id:
        result = get_bug_type_count_with_tester(int(tester_id))
    else:
...
def bug_category():
    ...
    if tester_id:
        result = get_bug_category_count_with_tester(int(tester_id))
    else:
...
@tester_api.route('/bug_trend', methods=['get'])
def bug_trend():
    """
    获取bug增长趋势
    :return:
    ...
    if tester_id:
        result = get_bug_trend_with_tester(int(tester_id))
    else:
